...
static uint8_t cursor;                          // cursor position
static uint8_t year;                            // year
static uint8_t month;                           // month
static uint8_t date;                            // date
static uint8_t hour;                            // hour
static uint8_t minute;                          // minute
static uint8_t second;                          // second
static uint8_t old_second;                      // old second
static uint8_t blink;                           // 

static void LCD_2BCD(uint8_t number)
