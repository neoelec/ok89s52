/* ========================================================================== */
/*          Exp10_7.c : -INT0 interrupt Count Program(No Debouncing)          */
/* ========================================================================== */
...
static uint8_t int_count = 0;                   // interrupt counter

static void INT0_ISR(void) __interrupt 0        // -INT0 interrupt function
{
